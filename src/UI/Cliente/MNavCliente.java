...
public class MNavCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Administración de Pago");

        jButton2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton2.setText("Compra de Pasajes");

        jButton3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton3.setText("Resumen de Compras");
        ...
        jButton7.setText("IR A INICIO");

        jButton4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton4.setText("Cuenta y Perfil");
