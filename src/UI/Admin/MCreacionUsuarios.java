...
public class MCreacionUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "User 1", "User 2", "User 3", "User 4", "User 4", "User 5" };
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chofer", "Administrador" }));
        ...
        jButton2.setText("Guardar usuario / Cancelar cambios");
